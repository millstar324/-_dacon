...
def train_pipeline(root_path):
    ...
    #모델의 어느 부분을 고정시키고 학습할것인지
    for param in model.net_g.parameters():
        param.requires_grad = False  # Enable gradient updates for the encoder
    for param in model.net_d.parameters():
        param.requires_grad = False  # Enable gradient updates for the encoder
    #for param in model.net_g.parameters():
    #for param in model.net_g.module.decoder.color_decoder.transformer_ffn_layers[0].parameters():
    for param in model.net_g.module.encoder.parameters():
        param.requires_grad = True  # Freeze the decoder
